    ...
    <div>
        ...
        <div className="container mx-auto py-16 px-4 lg:px-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-red-600 p-6 rounded-lg shadow-lg">
              ...
              <p className="text-white lg:scale-y-[1.20] text-3xl"  style={{ fontFamily: "'Playfair Display', serif" }}>
              3-130 hours (HSK 3) / 4-140 hours (HSK 4)<br /> </p> <br />
      ...
      <div className="bg-red-600 py-16 relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 px-4">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <h3 className="text-4xl scale-y-[1.20] font-bold text-red-600 mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>
                Chinese Pronunciation & Essential Vocabulary
              </h3>
        ...
        <div className="bg-yellow-400 py-16 relative">
          ...
          <div className="mt-12">
            <div className="container mx-auto bg-red-600 text-white rounded-full flex justify-between items-center px-8 py-4 shadow-lg">
              <p className="text-xl font-bold lg:text-2xl" style={{ fontFamily: "'Playfair Display', serif" }}>
              ...
              <a
                ...
                className="bg-white text-red-600 font-bold py-2 px-6 rounded-full shadow-lg"
